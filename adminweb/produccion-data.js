(function () {
  ...
  function makeEditorialOp(config) {
    return {
      id: config.id,
      page: "op-detalle.html?id=" + config.id,
      type: config.type,
      calendarType: "Plan actual",
      dueDate: config.dueDate,
      title: config.title,
      status: "Pendiente",
      priority: "Alta",
      platform: config.platform || "Instagram / Facebook / TikTok",
      format: config.format,
      pieces: config.pieces || "1 pieza",
      objective: config.objective,
      simpleBrief: config.brief,
      cta: config.cta,
      refs: config.refs || ["Ixmati Digital", "Web Vision", "Hook fuerte", "CTA claro"],
      instructions: config.instructions,
      examples: config.examples || ["Abre con el hook en los primeros 2 segundos.", "Usa texto grande, contraste alto y cortes limpios.", "Cierra con el CTA exacto de la OP."],
      deliverableGuide: config.deliverable || "Entrega MP4 vertical o storyboard completo con textos, tomas y duración.",
      avoid: config.avoid || ["No empieces con una presentación de Ixmati.", "No uses párrafos largos ni texto pequeño.", "No cambies el hook ni el CTA sin dejar nota."],
      slides: config.slides,
      socialCopy: config.socialCopy || [config.title, config.show, config.cta].filter(Boolean).join("\n\n"),
      noApproval: true,
      owner: config.owner || "FLOR"
    };
  }

  var septemberOps = [
    makeEditorialOp({ id: "OP-101", dueDate: "14 septiembre 2026", type: "REEL digital", format: "1080x1920", pieces: "1 reel vertical", title: "Si todavía confirmas todas tus citas por WhatsApp una por una, esto ya se puede hacer solo.", objective: "Demostrar automatización de confirmaciones y seguimiento sin trabajo manual.", brief: "El reel debe hacer que una persona dueña de negocio se reconozca en el problema y vea el flujo automatizado completo.", show: "WhatsApp → confirmación → recordatorio → seguimiento.", cta: "Hay procesos de tu negocio que ya no necesitan hacerse manualmente.", owner: "FLOR · DISEÑO · PUBLICACIÓN", instructions: ["Abre con el hook en pantalla durante el primer segundo, sin logo ni introducción.", "Muestra un mensaje entrante de cita y la confirmación automática.", "Corta al recordatorio programado antes de la cita.", "Cierra con el seguimiento posterior y el CTA en texto grande.", "Mantén ritmo de 6 a 10 cortes, subtítulos legibles y formato 9:16."], slides: [{title:"Hook 0–2s",text:"Si todavía confirmas todas tus citas por WhatsApp una por una, esto ya se puede hacer solo.",visual:"Texto grande sobre pantalla de WhatsApp."},{title:"Entrada",text:"Llega una solicitud de cita.",visual:"Mensaje entrante y datos del cliente."},{title:"Automatización",text:"Confirmación automática.",visual:"Respuesta enviada sin intervención manual."},{title:"Recordatorio",text:"Recordatorio antes de la cita.",visual:"Flujo programado con fecha y hora."},{title:"Cierre",text:"Hay procesos de tu negocio que ya no necesitan hacerse manualmente.",visual:"CTA y cierre de marca."}]}),
    makeEditorialOp({ id: "OP-102", dueDate: "16 septiembre 2026", type: "CARRUSEL digital", format: "1080x1350", pieces: "6 slides", title: "5 cosas de tu negocio que no deberían depender de que estés conectado.", objective: "Educar sobre automatización con situaciones cotidianas y fáciles de identificar.", brief: "Carrusel de lectura rápida: una idea por slide, contraste claro y cierre que convierta repetición en deseo de automatizar.", show: "Responder solicitudes · confirmar citas · registrar prospectos · dar seguimiento · enviar recordatorios.", cta: "Automatizar no es hacer menos. Es dejar de repetir.", owner: "FLOR · DISEÑO · PUBLICACIÓN", instructions: ["Slide 1: usa el título como portada con una tensión visual clara.", "Slides 2 a 6: una tarea por slide, número grande y ejemplo breve.", "Conserva la misma retícula, jerarquía y margen en todos los slides.", "El último slide debe cerrar con la frase CTA, sin agregar otro mensaje.", "Revisa que cada slide se entienda sin leer el caption."], slides: [{title:"Portada",text:"5 cosas de tu negocio que no deberían depender de que estés conectado.",visual:"Número 5 dominante y fondo limpio."},{title:"1",text:"Responder solicitudes.",visual:"Notificación entrando y respuesta automática."},{title:"2",text:"Confirmar citas.",visual:"Calendario con confirmación."},{title:"3",text:"Registrar prospectos.",visual:"Lead entrando a una ficha."},{title:"4 y 5",text:"Dar seguimiento. Enviar recordatorios.",visual:"Dos pasos conectados en un flujo."},{title:"Cierre",text:"Automatizar no es hacer menos. Es dejar de repetir.",visual:"CTA de cierre."}]}),
    makeEditorialOp({ id: "OP-103", dueDate: "17 septiembre 2026", type: "REEL digital", format: "1080x1920", pieces: "1 reel vertical", title: "Tu Excel no está mal. El problema empieza cuando toda tu empresa depende de él.", objective: "Introducir sistemas internos y plataformas administrativas como evolución natural de una operación que creció.", brief: "No ataques Excel: muestra el momento exacto en que la información se dispersa y cómo un panel central devuelve control.", show: "Excel → información dispersa → panel centralizado.", cta: "Tu operación también puede tener su propio sistema.", owner: "FLOR · DISEÑO · PUBLICACIÓN", instructions: ["Abre con el hook completo en texto grande y una hoja de Excel reconocible.", "Muestra duplicados, mensajes sueltos y datos que no coinciden.", "Haz una transición visual al panel centralizado con módulos claros.", "Enseña búsqueda, estado y responsable en menos de tres segundos.", "Cierra con el CTA, sin vender funciones que no aparecen."], slides: [{title:"Hook",text:"Tu Excel no está mal.",visual:"Hoja de cálculo limpia."},{title:"Problema",text:"El problema empieza cuando toda tu empresa depende de él.",visual:"Varias copias y mensajes dispersos."},{title:"Cambio",text:"Información dispersa → panel centralizado.",visual:"Transición de caos a interfaz."},{title:"Sistema",text:"Tu operación también puede tener su propio sistema.",visual:"Panel con módulos y responsables."}]}),
    makeEditorialOp({ id: "OP-104", dueDate: "21 septiembre 2026", type: "REEL digital", format: "1080x1920", pieces: "1 reel vertical", title: "¿Cuántas ventas se te van porque contestaste tres horas después?", objective: "Mostrar CRM, alertas y seguimiento automático para no perder leads por demora.", brief: "El espectador debe ver el costo de no responder y entender que el seguimiento puede ser un proceso, no un recuerdo.", show: "Lead → registro → alerta → seguimiento.", cta: "El seguimiento no debería depender de acordarte.", owner: "FLOR · DISEÑO · PUBLICACIÓN", instructions: ["Abre con la pregunta y un reloj avanzando.", "Muestra el lead entrando y quedando registrado automáticamente.", "Activa una alerta visible para el equipo.", "Muestra el siguiente paso de seguimiento y el cambio de estado.", "Cierra con el CTA exacto y una pausa de lectura de un segundo."], slides: [{title:"Hook",text:"¿Cuántas ventas se te van porque contestaste tres horas después?",visual:"Reloj y notificación sin responder."},{title:"Lead",text:"Entra un prospecto.",visual:"Formulario o WhatsApp entrando al CRM."},{title:"Alerta",text:"El equipo recibe una alerta.",visual:"Aviso con responsable y hora."},{title:"Seguimiento",text:"El seguimiento no debería depender de acordarte.",visual:"Estado actualizado y CTA."}]}),
    makeEditorialOp({ id: "OP-105", dueDate: "22 septiembre 2026", type: "REEL Web Vision", format: "1080x1920", pieces: "1 reel reveal", title: "¿Y si pudieras ver tu página web antes de pagar por hacerla?", objective: "Revelar Web Vision mostrando el producto directamente y reducir la incertidumbre antes de contratar.", brief: "No abras con Ixmati presenta. El producto es el protagonista: el recorrido debe sentirse rápido, claro y posible.", show: "nombre del negocio → giro → servicios → estilo → colores/logo → objetivos → funciones → generar → simulación.", cta: "Pruébala gratis. Tarda menos de 5 minutos.", owner: "FLOR · DISEÑO · PUBLICACIÓN", instructions: ["Empieza con la pregunta-hook sobre fondo de la interfaz, sin logo inicial.", "Graba el recorrido real, manteniendo cada paso visible 1–2 segundos.", "Usa acercamientos solo para campos clave: giro, estilo, logo y objetivos.", "Haz que el clic GENERAR sea el momento de mayor expectativa.", "Termina en la simulación y deja el CTA en pantalla al menos dos segundos."], refs:["Web Vision","Simulación","Reveal","Prueba gratis"], slides: [{title:"Hook",text:"¿Y si pudieras ver tu página web antes de pagar por hacerla?",visual:"Interfaz Web Vision entrando en cuadro."},{title:"Configura",text:"Nombre, giro, servicios, estilo, colores y logo.",visual:"Campos del wizard en cortes rápidos."},{title:"Objetivos",text:"Elige qué quieres conseguir y qué funciones necesitas.",visual:"Opciones seleccionables."},{title:"Generar",text:"Generar.",visual:"Botón GENERAR como punto de tensión."},{title:"Reveal",text:"Pruébala gratis. Tarda menos de 5 minutos.",visual:"Simulación final y CTA."}]}),
    makeEditorialOp({ id: "OP-106", dueDate: "23 septiembre 2026", type: "CARRUSEL digital", format: "1080x1350", pieces: "3 slides", title: "Página web vs sistema web", objective: "Ayudar a distinguir entre informar, captar y operar un negocio desde una solución digital.", brief: "Comparación visual directa: no es una lista técnica, es una decisión que la persona pueda reconocer en segundos.", show: "PÁGINA: informa · presenta · capta. SISTEMA: procesa · automatiza · organiza · conecta operaciones.", cta: "Tu negocio puede necesitar mucho más que una página.", owner: "FLOR · DISEÑO · PUBLICACIÓN", instructions: ["Portada: plantea la comparación con dos bloques muy contrastados.", "Slide 2: resume página en tres verbos, sin explicación extra.", "Slide 3: resume sistema en cuatro verbos y remata con CTA.", "Usa un color por columna y conserva la misma alineación.", "Evita decir que una opción es mejor: depende de la operación."], slides: [{title:"Portada",text:"Página web vs sistema web",visual:"Dos columnas con iconos de página y sistema."},{title:"Página",text:"Informa · presenta · capta.",visual:"Sitio web, formulario y CTA."},{title:"Sistema",text:"Procesa · automatiza · organiza · conecta operaciones.",visual:"Flujo, panel y módulos conectados."}]}),
    makeEditorialOp({ id: "OP-107", dueDate: "24 septiembre 2026", type: "REEL Web Vision", format: "1080x1920", pieces: "1 reel tutorial", title: "Te voy a enseñar cómo puedes visualizar la página de tu negocio sin tener que contratar nada primero.", objective: "Enseñar el recorrido real de Web Vision para que cualquier negocio pueda probarlo sin asistencia.", brief: "Tutorial grabado por Jared. La pantalla debe ser protagonista y el guion debe sonar conversado, directo y sin tecnicismos.", show: "Grabación de pantalla de todo el flujo: datos, estilo, logo, objetivos, generar, simulación y diagnóstico.", cta: "Haz la de tu negocio. Es gratis y te toma menos de cinco minutos.", owner: "JARED · GRABACIÓN / FLOR · EDICIÓN", instructions: ["Jared debe grabar una toma continua y otra por bloques para facilitar edición.", "Antes de grabar, prepara un negocio de ejemplo y un logo de prueba.", "Muestra cada clic sin saltos: nombre, giro, servicios, estilo, colores y logo.", "Deja visible el diagnóstico y la estimación al final.", "Flor edita silencios, agrega subtítulos y mantiene el CTA final."], slides: [{title:"Entrada",text:"Te voy a enseñar cómo puedes visualizar la página de tu negocio sin tener que contratar nada primero.",visual:"Jared en voz o texto sobre la pantalla."},{title:"Datos",text:"Escribes cómo se llama tu negocio y qué haces.",visual:"Campos iniciales del wizard."},{title:"Marca",text:"Eliges cómo quieres que se sienta tu marca; puedes poner colores y subir logo.",visual:"Estilo, color y carga de logo."},{title:"Objetivos",text:"Seleccionas qué quieres conseguir y qué funciones necesitarías.",visual:"Objetivos y funciones."},{title:"Generar",text:"GENERAR. Web Vision construye una simulación.",visual:"Click, espera breve y resultado."},{title:"Cierre",text:"Haz la de tu negocio. Es gratis y te toma menos de cinco minutos.",visual:"Simulación, diagnóstico y CTA."}]}),
    makeEditorialOp({ id: "OP-108", dueDate: "28 septiembre 2026", type: "DEMO Web Vision", format: "1080x1920", pieces: "1 demo vertical", title: "Probamos Web Vision con una cafetería.", objective: "Crear la primera demo reutilizable después del lanzamiento y mostrar cómo se decide una solución.", brief: "Caso rápido de principio a fin: negocio real, decisiones concretas y resultado visible.", show: "Nombre, menú, reservas, ubicación, WhatsApp y simulación final.", cta: "Pruébala con tu negocio.", owner: "FLOR · DISEÑO · PUBLICACIÓN", instructions: ["Presenta la cafetería en una frase y plantea qué necesita.", "Captura los datos y decisiones dentro de Web Vision.", "Muestra el resultado con tres acercamientos: hero, menú y contacto.", "Incluye una reacción o conclusión: qué resolvió la simulación.", "Cierra invitando a probar otro negocio."], slides: [{title:"Caso",text:"Probamos Web Vision con una cafetería.",visual:"Nombre y giro del negocio."},{title:"Decisiones",text:"Menú, reservas, ubicación y WhatsApp.",visual:"Configuración de necesidades."},{title:"Resultado",text:"Así podría verse y funcionar.",visual:"Simulación con scroll rápido."}]}),
    makeEditorialOp({ id: "OP-109", dueDate: "29 septiembre 2026", type: "REEL digital", format: "1080x1920", pieces: "1 reel vertical", title: "Una automatización que te ahorra 30 mensajes al día.", objective: "Conectar automatización con ahorro de tiempo y una situación operativa concreta.", brief: "El hook debe prometer un beneficio tangible y luego enseñar el flujo que elimina mensajes repetidos.", show: "Solicitud repetida → flujo automático → equipo liberado para atender mejor.", cta: "Hay procesos de tu negocio que ya no necesitan hacerse manualmente.", owner: "FLOR · DISEÑO · PUBLICACIÓN", instructions: ["Abre con el número 30 y el hook en pantalla.", "Muestra tres mensajes repetidos que llegan durante el día.", "Transforma esos mensajes en un flujo con respuesta y registro automático.", "Enseña el tiempo liberado como resultado, no como promesa abstracta.", "Cierra conectando con automatización a la medida."], slides: [{title:"Hook",text:"Una automatización que te ahorra 30 mensajes al día.",visual:"Contador y bandeja saturada."},{title:"Repetición",text:"La misma pregunta llega una y otra vez.",visual:"Mensajes repetidos."},{title:"Flujo",text:"Respuesta, registro y seguimiento automáticos.",visual:"Nodos conectados."},{title:"Cierre",text:"Hay procesos de tu negocio que ya no necesitan hacerse manualmente.",visual:"Equipo enfocado y CTA."}]}),
    makeEditorialOp({ id: "OP-110", dueDate: "29 septiembre 2026", type: "DEMO Web Vision", format: "1080x1920", pieces: "1 demo vertical", title: "¿Qué página necesitaría una clínica dental?", objective: "Mostrar cómo Web Vision traduce un giro específico en funciones útiles para captar y atender pacientes.", brief: "La demo debe responder qué necesita la clínica, no solo enseñar una página bonita.", show: "Servicios, agenda, formulario, ubicación, preguntas frecuentes y WhatsApp.", cta: "Descubre la de tu negocio.", owner: "FLOR · DISEÑO · PUBLICACIÓN", instructions: ["Plantea la pregunta del caso en los primeros dos segundos.", "Selecciona servicios y objetivo de agendar pacientes.", "Muestra funciones recomendadas y la simulación resultante.", "Haz zoom a agenda, formulario y WhatsApp.", "Cierra con la invitación a descubrir la propia solución."], slides: [{title:"Pregunta",text:"¿Qué página necesitaría una clínica dental?",visual:"Pregunta sobre interfaz."},{title:"Necesidad",text:"Servicios, agenda y captación de pacientes.",visual:"Objetivos seleccionados."},{title:"Resultado",text:"Una web que informa y ayuda a agendar.",visual:"Simulación final."}]}),
    makeEditorialOp({ id: "OP-111", dueDate: "30 septiembre 2026", type: "DEMO Web Vision", format: "1080x1920", pieces: "1 demo vertical", title: "Así sería la web de un restaurante.", objective: "Demostrar variedad de escenarios y cómo una simulación aterriza una experiencia comercial.", brief: "Haz que se sienta como una visita: menú, reserva y ubicación deben aparecer como acciones, no como lista.", show: "Menú, reservas, ubicación, horarios y contacto desde la simulación.", cta: "Pruébala con tu negocio.", owner: "FLOR · DISEÑO · PUBLICACIÓN", instructions: ["Abre con una toma atractiva del resultado final.", "Regresa al wizard y muestra las decisiones del restaurante.", "Enseña menú, reservar, ubicación y horarios en recorrido rápido.", "Incluye una toma móvil para reforzar uso real.", "Cierra con el CTA exacto y URL visible si aplica."], slides: [{title:"Resultado",text:"Así sería la web de un restaurante.",visual:"Hero con platillo y CTA."},{title:"Funciones",text:"Menú, reservas, ubicación y horarios.",visual:"Secciones navegables."},{title:"Cierre",text:"Pruébala con tu negocio.",visual:"Vista móvil y CTA."}]}),
    makeEditorialOp({ id: "OP-112", dueDate: "30 septiembre 2026", type: "DEMO Web Vision", format: "1080x1920", pieces: "1 demo vertical", title: "Este negocio pensaba que necesitaba una página. En realidad necesitaba citas + WhatsApp + seguimiento.", objective: "Posicionar Web Vision como diagnóstico de solución y abrir conversaciones comerciales de mayor valor.", brief: "La historia debe mostrar el cambio de entendimiento: una petición vaga se convierte en funciones y proceso concreto.", show: "Petición inicial → diagnóstico → citas + WhatsApp + seguimiento → simulación.", cta: "Ve qué necesita realmente tu negocio.", owner: "FLOR · DISEÑO · PUBLICACIÓN", instructions: ["Abre con la frase larga como hook, en dos pantallas para facilitar lectura.", "Muestra la petición inicial como una nota breve del negocio.", "Enseña el diagnóstico y las funciones recomendadas.", "Recorre el resultado conectando cada función con una necesidad real.", "Cierra con la invitación a descubrir qué necesita el propio negocio."], slides: [{title:"Hook",text:"Este negocio pensaba que necesitaba una página.",visual:"Petición inicial en pantalla."},{title:"Giro",text:"En realidad necesitaba citas + WhatsApp + seguimiento.",visual:"Diagnóstico y funciones destacadas."},{title:"Resultado",text:"Ve qué necesita realmente tu negocio.",visual:"Simulación con flujo de contacto."}]}),
    makeEditorialOp({ id: "OP-113", dueDate: "30 septiembre 2026", type: "CONVERSIÓN Web Vision", format: "1080x1920", pieces: "1 reel conversión", title: "Ya viste cómo podría funcionar. Ahora podemos construirla.", objective: "Convertir la prueba y el diagnóstico de Web Vision en solicitudes de proyecto para Ixmati.", brief: "Cierra el recorrido con claridad: primero visualizar, después construir con la solución correcta.", show: "Resultado de Web Vision → diagnóstico → siguiente paso con Ixmati.", cta: "Solicitar proyecto / contactar Ixmati.", owner: "FLOR · DISEÑO · PUBLICACIÓN", instructions: ["Recupera en un segundo el resultado de una demo anterior.", "Muestra el diagnóstico como puente entre idea y proyecto.", "Explica visualmente que Ixmati construye la solución real.", "Incluye un CTA único y visible, sin opciones compitiendo.", "Deja datos de contacto y enlace revisados antes de publicar."], slides: [{title:"Recap",text:"Ya viste cómo podría funcionar.",visual:"Simulación Web Vision."},{title:"Puente",text:"Ahora podemos construirla.",visual:"Diagnóstico y alcance del proyecto."},{title:"CTA",text:"Solicitar proyecto / contactar Ixmati.",visual:"Botón y datos de contacto."}]})
  ];
  defaultOps = defaultOps.concat(septemberOps);
  ...
  function statusClass(status) {
    if (status === "En diseno" || status === "Preparando") return "design";
    if (status === "En revision" || status === "Enviado a aprobacion") return "review";
    if (status === "Aprobado" || status === "Publicado" || status === "Listo") return "done";
